...
$axure.internal(function($ax) {
    ...
    var getVariableValue = function(variable, eventInfo, ignoreDefaultsForLinkUrl) {
        ...
        switch(variable) {
            ...
            case "item": return eventInfo.targetElement ? getVariableValue('targetitem', eventInfo, ignoreDefaultsForLinkUrl) : eventInfo && eventInfo.item && eventInfo.item.valid && eventInfo.item;
    ...
    var getLinkUrl = function(baseUrl, useGlobalVarName) {
        ...
        if (window.parent && window.parent.CLOUD_VAR_NAME) {
